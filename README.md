...
|-----------------------------|------------------------------------------|------------------------------------------|------------|
| [basic_calculator](basic_calculator/)     | Simple command-line calculator           | Functions, conditionals, user input, error handling | Beginner   |
| [investment_calculator](investment_calculator/) | Compound interest & investment growth simulator | Loops, math operations, formatting output, maybe lists/dicts | Beginner → Intermediate |
| [number_guessing_game](number_guessing_game/) | A fun game where the user guesses a random number | Loops, random module, conditionals, user input | Beginner   |
| [temp_converter](temp_converter/)         | Celsius ↔ Fahrenheit / Kelvin converter  | Functions, type conversion, basic math   | Beginner   |
...
- Suggest new project ideas in [Discussions](https://github.com/tm4rtin17/small-python-projects/discussions) or Issues
